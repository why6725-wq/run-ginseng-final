...
- 근거를 밝히되 순서를 지키십시오. 사람 이야기가 먼저, 명리 근거는 그 뒤에 붙입니다.
  나쁨: "월지가 편관이라 조직에서 압박을 크게 느낍니다."
  좋음: "위에서 누르는 압박을 남보다 크게 느끼는 편입니다. 월지에 편관을 놓아서 그렇습니다."
  같은 내용인데 뒤쪽이 자기 이야기로 읽힙니다. 표를 해설하지 말고 사람을 설명하십시오.
- 성격 딱지만 늘어놓지 마십시오. "책임감이 강합니다" 같은 말은 누구에게나 해당됩니다.
  언제 어떤 상황에서 어떻게 행동하는지, 장면이 그려지게 쓰십시오.
